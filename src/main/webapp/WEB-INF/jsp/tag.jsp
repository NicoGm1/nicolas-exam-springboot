...
<%@ page import="fr.nsurget.nicolasexamspringboot.appli_name.mapping.WebUrlRoute" %>

<%-- Imports nécessaires pour récupérer le UserService dans les JSP --%>
<%@ page import="org.springframework.web.servlet.support.RequestContextUtils" %>
<%@ page import="org.springframework.web.context.WebApplicationContext" %>
<%--<%@ page import="fr.nsurget.nicolasexamspringboot.appli_name.service.UserService" %>--%>
<%--<%@ page import="fr.nsurget.nicolasexamspringboot.appli_name.entity.User" %>--%>
